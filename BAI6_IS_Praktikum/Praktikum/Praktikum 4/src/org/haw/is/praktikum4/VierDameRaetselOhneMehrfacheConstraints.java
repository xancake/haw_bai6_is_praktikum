...
public class VierDameRaetselOhneMehrfacheConstraints {
	...
	public static void main(String[] args) {
		...
		BinaryCompareFunction dif1 = (l,r) -> l!=r && l+1!=r && l-1!=r;
		BinaryCompareFunction dif2 = (l,r) -> l!=r && l+2!=r && l-2!=r;
		BinaryCompareFunction dif3 = (l,r) -> l!=r && l+3!=r && l-3!=r;
		
		net.addConstraint(new BinaryConstraint("1--2", v1, v2, dif1));
		net.addConstraint(new BinaryConstraint("1--3", v1, v3, dif2));
		net.addConstraint(new BinaryConstraint("1--4", v1, v4, dif3));
		net.addConstraint(new BinaryConstraint("2--3", v2, v3, dif1));
		net.addConstraint(new BinaryConstraint("2--4", v2, v4, dif2));
		net.addConstraint(new BinaryConstraint("3--4", v3, v4, dif1));
